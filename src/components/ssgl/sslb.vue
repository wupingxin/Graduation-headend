  ...
  <div>
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column prop="ssz" label="寝室长"></el-table-column>
        <el-table-column prop="member" label="人员状态">
          <template slot-scope="scope">
            <el-tag v-if="scope.row.child.length < 5">未满</el-tag>
          ...
          <template slot-scope="scope">
            ...
            <el-tooltip effect="dark" content="分配学生" placement="top" :enterable="false">
              <el-button
                ...
                icon="el-icon-plus"
                size="mini"
                v-if="scope.row.child.length < 5 ? true:false"
      ...
      >
        <!-- 内容主体 disabled是固定不可改  clearable是可改-->
        <el-form :model="editForm" ref="editFormRef" :rules="editFormRules" label-width="120px">
          <el-form-item label="姓名" prop="name">
            <el-input v-model="editForm.name" clearable></el-input>
          </el-form-item>
          <el-form-item label="学号" prop="stuNumber">
            <el-input v-model="editForm.stuNumber" clearable></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleSizeChange(newSize) {
      console.log(newSize);
      newSize = this.queryInfo.pagesize ;
      var _this = this;
      this.$http
        .post("http://localhost:3000/dormList/search", {
          lynumber: this.lynumber,
    ...
    showEditDialog(user) {
      ...
      this.editForm.stuNumber = user.stuNumber;
