    ...
    <el-card>
      ...
      <el-dialog title="请您选择支付方式" :visible.sync="ChoosePaymentMethod" width="50%" @close="dialogClosed">
        ...
        <el-tabs type="border-card">
          <el-tab-pane label="支付宝支付"><img src="../../assets/img/zfb.jpg" alt="支付宝码"></el-tab-pane>
          <el-tab-pane label="微信支付"><img src="../../assets/img/weixin.jpg" alt="微信支付码"></el-tab-pane>
        </el-tabs>
        <!-- 底部按钮区 -->
