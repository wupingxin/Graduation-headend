    ...
    <div class="bg">
      ...
      <el-card>
        <el-form :model="userForm" ref="userFormRef" label-width="80px">
          <el-row>
            <el-col :span="6">
              <el-form-item label="姓名" prop="name">
                <el-input v-model="userForm.name" clearable :disabled="isTj"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="性别" prop="sex">
                <el-input v-model="userForm.sex" clearable :disabled="isTj"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="账号" prop="uname">
                <el-input v-model="userForm.uname" clearable :disabled="isTj"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
          ...
          <el-row>
            <!-- <el-col :span="6">
              <el-form-item label="所属学院" prop="xueyuan">
