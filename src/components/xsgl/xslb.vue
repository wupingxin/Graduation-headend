<template>
  <div>
        ...
        <el-row>
          ...
          <el-col :span="6">
            <el-form-item label="学号">
              <el-input v-model="stuNumber" placeholder="请输入学生学号" clearable></el-input>
            </el-form-item>
          </el-col>
          <!-- 要搜索学生的姓名 -->
          <el-col :span="6">
        ...
        <el-row>
          ...
          <el-col :span="5">
            <el-form-item label="班级">
              <el-input v-model="banji" placeholder="请输入班级名字" clearable></el-input>
            </el-form-item>
          </el-col>
          <!-- 搜索按钮 -->
          <el-col :span="3">
    ...
    <el-card>
      <el-row></el-row>
      <!-- 列表数据 -->
      <el-table :data="studentlist" stripe border height="210">
      ...
      >
        ...
        <el-form :model="viewForm" ref="viewFormRef" label-width="120px">
          <el-row>
            <el-col :span="6">
              <el-form-item label="学号" prop="stuNumber">
                <el-input v-model="viewForm.stuNumber" clearable></el-input>
              </el-form-item>
              <el-form-item label="学院" prop="xueyuan">
...
export default {
    ...
    return {
      ...
      addFormRules: {
        ...
        stuNumber: [
          ...
          { min: 8, max: 10, message: "长度在 8x 到 10 个字符", trigger: "blur" }
        ],
        xueyuan: [
  ...
  methods: {
    ...
    showEditDialog(user) {
      ...
      this.viewForm.stuNumber = user.stuNumber;
